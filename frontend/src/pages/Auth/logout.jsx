    ...
    return (
        <div className="relative w-screen h-screen overflow-hidden bg-black">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-white">
                {/* Logo */}
                <Link to={config.routes.Home} className="absolute top-20 left-20 w-40">
                    <img src={images.logo} alt="Galaxy Play Logo" />
                </Link>
                <div className="flex  flex-col gap-6 w-[33%]  bg-opacity-50 rounded-lg shadow-md p-[3%]">
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className=" space-y-6">
                            ...
                            <Button
                                className="w-full !mt-12 !p-10 hover:cursor-pointer hover:bg-slate-300 flex items-center justify-center py-2 text-[1.4vw] hover:opacity-90 rounded-[999px] font-medium text-black bg-zinc-100
                        disabled:bg-gray-400 disabled:cursor-default disabled:opacity-100"
                                type="submit"
                            >
                                Đăng ký
                            </Button>
